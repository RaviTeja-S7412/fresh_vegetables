...
<!--						<h5 class="m-b-20">Accordion</h5>-->
	...
	if($oid == ""){				
				$cid = 0;
					...
					$products = $this->db->query("select * from tbl_products where status='Active' and deleted=0 and product_category='$cat->id' and assigned_to='agents' order by id asc")->result();
...
<!--						</form>			-->
					...
					<label>Enter Quantity</label>
							...
							<input type="number" name="qty[]" class="form-control"  value="<?php echo $ppp->productQty ?>" />
						</div>						
...
<!--						<input type="hidden" name="product_id" id="product_id">-->
								...
								<div class="form-group row">
									...
									<div class="input-group m-t-10">
										...
										<?php
											...
											$agent = isset($u->agent_id) ? $u->agent_id : '';
											...
											<option value="<?php echo $a->id ?>" <?php echo ($agent == $a->id) ? "selected" : "" ?> ><?php echo $a->name ?></option>
					...
					<div class="row">													
							...
							<div class="col-sm-12 col-md-3">
								<div class="form-group">
									...
									Payment Receipt
									<div class="input-group m-t-10">
										<input type="file" id="files" class="form-control" name="files" placeholder="Payment Receipt">
									</div>
				...
				<?php if(isset($u->transaction_document)){ ?>		
					<div class="container" align="right">
						...
						<img src="<?php echo base_url().$u->transaction_document ?>">
