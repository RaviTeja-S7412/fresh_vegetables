					...
					<tr>
						...
						<td>   
						   <?php  
								...
								echo $this->db->get_where("fdm_va_auths",array("id"=>$u->agent_id))->row()->name; 
							?>
						</td>
						
						<td style="padding: 0.5rem;"><?php echo date("d.m.Y",strtotime($u->transaction_date)) ?></td>
						...
						<?php $image = ($u->transaction_document != "") ? base_url().$u->transaction_document : "";  ?>
						
						<td style="padding: 0.5rem;"><?php if($image != ""){ ?><img src="<?php echo $image ?>" style="width: 50%"><?php } ?></td>
...
$("#filter").click(function(){
	...
	var table = $('#zero_config1').dataTable({
         "bProcessing": true,
         "ajax": {
			"url": "<?php echo base_url("orders/agentorders/filterdepositOrders") ?>",
			"type": "POST",
