								   ...
								   foreach ($doo as $u) {
                                           ...
                                           ?> 
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 0.5rem;"><?php echo date("d-M-Y H:i:s",strtotime($u->date_of_order)) ?></td>
                                               
                                                <td style="padding: 0.5rem;" align="center">
                                                <?php	
											   
											   		if($u->order_status == "Success" && $u->delivery_status != "Out" && $u->delivery_status != "Success"){
											   	
														echo '<a class="btn btn-primary waves-effect waves-light" href="'.base_url('orders/Activeorders/outFordelivery/').$u->order_id.'">Out For Delivery</a>';	
														...
														}elseif($u->delivery_status == "Out"){

															echo '<span class="badge badge-warning" style="color:white">Out For Delivery</span>';
														}else{
                                               ...
                                               <td style="padding: 0.5rem;"><?php echo $u->payment_type ?></td>
                                               <td style="padding: 0.5rem;"><?php if($u->order_status != "Success"){
													
													echo '<a class="btn btn-primary waves-effect waves-light" href="'.base_url('orders/Activeorders/updateOrderstatus/').$u->order_id.'">Confirm</a>';
											   ...
											   ?>
                                                ...
                                                <td style="padding: 0.5rem;"><?php echo $u->total_amount." Rs/-" ?></td>

												<td style="padding: 0.5rem;">
												
													<a href="<? echo base_url('orders/Activeorders/viewOrder/').$u->order_id ?>" target="_blank"><i class="fa fa-eye"></i></a>&nbsp;&nbsp;
													
													<? if($u->delivery_status == "Out"){ ?>
													
													<a href="javascrip:void(0)" class="text-inverse p-r-10 getOid" id="<?php echo $u->order_id ?>"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
													
													<? } ?>
												
													<?php //if($u->order_status != "Success"){ ?>
													
													<a href="<? echo base_url('orders/Activeorders/delOrder/').$u->order_id ?>" data-toggle="tooltip" title="Cancel Order" onClick="return confirm('Are you sure want to delete')"><i class="fa fa-times" style="color: red"></i></a>
						  ...
						  <div class="modal-dialog">
							...
							<div class="modal-content">
							  <div class="modal-header">
								<h4 class="modal-title" align="center">Update Delivery Status</h4>
							  </div>
