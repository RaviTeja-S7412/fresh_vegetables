                ...
                <div class="row">
				   ...
				   ?> 
								...
								<tr>
									...
									<td style="padding: 0.5rem;"><?php foreach($orderproducts as $op){								   
					   
					                    echo $this->db->get_where("tbl_products",array("id"=>$op->product_id,"deleted"=>0))->row()->product_id."<br>"; 
									}
					                    ?></td>
									<td style="padding: 0.5rem;"><?php foreach($orderproducts as $op){								   
					   
					                    echo $this->db->get_where("tbl_products",array("id"=>$op->product_id,"deleted"=>0))->row()->product_name."<br>"; 
									}  ?></td>
