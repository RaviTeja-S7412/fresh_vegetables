                ...
                <div class="navbar-header">
                    ...
                    <?php } ?>    
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url().$d->db->get_where("fdm_va_general_logo",array("logo_type"=>"Header"))->row()->logo ?>" alt="homepage" class="dark-logo" style="height: 50px; width: 100%">&nbsp;
                            <!-- Light Logo icon -->
                            <!-- <img src="<?php echo base_url().$d->db->get_where("fdm_va_general_logo",array("logo_type"=>"Header"))->row()->logo ?>" alt="homepage" class="light-logo" style="height: 50px; width: 100%" /> -->
                        </b>
                        <!--End Logo icon -->
