...
-->
                ...
                <?php if($r1 == 1){ ?>
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>products/categories/categories/updateCategory" enctype="multipart/form-data">
                                <div class="card-body">
                                        ...
                                        <div class="col-sm-12 col-lg-3 col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="brand" class="form-control" placeholder="Brand Name" required="" value="<?php echo $cat->brand_name ?>">
                                                </div>
                ...
                <?php }else{ ?>
                   ...
                   <form class="form-horizontal" method="post" action="<?php echo base_url() ?>products/categories/categories/insertCategory" enctype="multipart/form-data">
                                <div class="card-body">
                                    <!-- <h4 class="card-title">Employee User</h4> -->
                                    <div class="row">
                                        <div class="col-sm-12 col-lg-3 col-md-3">
										...
										$opt = $this->db->query("select * from tbl_categories order by id desc")->result();       	
                                           foreach ($opt as $u) {  ?> 
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;"><img src="<?php echo base_url().$u->image ?>" class="" style="width: 100%"></td>
                                                <td style="vertical-align: middle;"><?php echo $u->category_name ?></td>
                                                <td style="vertical-align: middle;"><?php echo $u->brand_name ?></td>
                                                <td style="vertical-align: middle; padding: 0px">
 												
                                                    <a href="<?php echo base_url("products/edit-category/").$u->id ?>" class="text-inverse sa-params"  ><i class="ti-marker-alt"></i></a>&nbsp;
                                                    <a href="<? echo base_url('products/categories/Categories/delCat/').$u->id ?>" name="delete" value="<?php echo $u->id ?>" id="<?php echo $u->id ?>" class="text-inverse sa-params"  onclick="return confirm('Are you sure want to delete')"><i class="ti-trash"></i></a>
