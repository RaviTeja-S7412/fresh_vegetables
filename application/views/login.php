...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(<?php echo base_url() ?>assets/front/assets/images/banner.jpg) no-repeat;">
            <div class="auth-box on-sidebar" style=" height : 60% !important; top: 50px !important;" align="center">
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><!-- <img src="<?php //echo base_url().$this->db->get_where("fdm_va_general_logo",array("logo_type"=>"Header"))->row()->logo ?>" alt="logo" style="width: 100%; height: 90px"> --><i class="fa fa-lock fa-3x" aria-hidden="true"></i></span>
                        ...
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" id="loginform" method="post" action="<?php echo base_url() ?>login/do_login">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Username" aria-label="Username" name="email" id="uname" aria-describedby="basic-addon1">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
