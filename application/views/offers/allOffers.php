                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
													...
													$products = $this->db->get_where("tbl_products",array("deleted"=>0,"status"=>"Active"))->result();
													foreach($products as $pr){
													?>
                                                    	
                                                    	<option value="<?php echo $pr->id ?>" <?php echo ($prId == $pr->id) ? "selected" : "" ?>><?php echo $pr->product_name ?></option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-success">
                                                    <label class="control-label">Price</label>
                                                     <input type="text" name="price" class="form-control" placeholder="Price in RS" value="<?php echo isset($o->price) ? $o->price : ""; ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group has-danger">
													...
													$cities = $this->db->get_where("tbl_locations",array("status"=>1,"deleted"=>0))->result(); 
