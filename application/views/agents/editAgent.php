        ...
        <div class="page-wrapper">
                        ...
                        <div class="d-flex no-block justify-content align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo base_url() ?>agents/all-agents">Clients</a>
                                    </li>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                   	  <div class="col-md-8">
                    	<i class="fa fa-user"></i> Update Client
                      </div>
                      <div class="col-md-3" style="text-align: right">
                       <a href="<?php echo base_url() ?>agents/create-agent">	
                    	<button class="btn btn-success waves-effect waves-light">Create Client</button>
                       </a>	
                      </div>
                                       ...
                                       <div class="col-sm-12 col-lg-3 col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="agent_id" class="form-control" placeholder="Client ID" required="" value="<?php echo $u->agent_id ?>">
                                                </div>
